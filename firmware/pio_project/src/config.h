...
// ─── Hardware Enable ────────────────────────────────────────────
// Set to false when running ESP32 dev board without peripherals
// (no keypad, LCD, relay, sensors). Only WiFi + API will run.
#define HARDWARE_ATTACHED   true
...
// NOTE: Requires NTP time sync for cert validation to work on ESP32.
//       Set to false until NTP is configured.
